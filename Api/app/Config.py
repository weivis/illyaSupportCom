...
SQLALCHEMY_DATABASE_URI = "mysql://root:weivimysql@0.0.0.0:3306/illya_support?charset=utf8mb4"
...
API_DOC_MEMBER = ['api/photo','api/comment','api/open','api/cv','api/admin','api/album','api/bangumi','api/auth','api/bbs','api/article','api/user','api/video','api/upload','Api接口文档说明']
